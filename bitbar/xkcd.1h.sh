...
# <bitbar.desc>Display XKCD Strip</bitbar.desc>
...
echo "| image=$IMAGE"
echo ---
echo "$TITLE | size=14 href='https://www.xkcd.com/$IMG_NUM/'"
echo "${SUB_TITLE}"
echo "Explain XKCD wiki | href='https://www.explainxkcd.com/$IMG_NUM"
echo ---
