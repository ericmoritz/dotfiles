...
conf = json.load(open(os.path.join(os.path.dirname(__file__), "../.etc/bitbar.json")))

ACCESS_TOKEN = conf["github-review-requests"]['ACCESS_TOKEN']

GITHUB_LOGIN = conf["github-review-requests"]['GITHUB_LOGIN']
